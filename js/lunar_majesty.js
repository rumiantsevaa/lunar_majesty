const cards = [
  ...
  },
  {
    ...
    content: "The dreams of these lunar days, as a rule, show how harmoniously we move in the material and spiritual world. The figures that you are, clearly express your position at a given moment in time. If the dream is good and you act in a positive role, then your development is in the right direction. If you act as you are causing troubles, or you yourself cause them, then in life somewhere you act wrong, or your spiritual world is in desolation. The good dreams of these lunar days are fortunately. They can carry useful information, be broadcast, and, as a rule, are executed. Sometimes they say that the dream that you had that night may come true in 3 days. Sometimes you may not see dreams at this time, then life gives you the opportunity to take place simply, since the day itself is not the lightest and very energy.",
